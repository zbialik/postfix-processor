...
public class StackLinked implements Stack {
	...
	public static Logger LOGGER = LogManager.getLogger(StackLinked.class.getName());
	...
	*/
	public boolean isEmpty() throws Exception {
		if (this.size == 0) {
			...
			LOGGER.error("stack size is negative");
	...
	*/
	public Object pop() throws Exception {
		if (this.isEmpty()) {
			LOGGER.warn("stack is empty - returning null as popped value");
			return null;
